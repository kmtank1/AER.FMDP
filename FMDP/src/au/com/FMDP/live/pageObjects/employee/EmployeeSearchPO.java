...
public class EmployeeSearchPO 
{
	...
	public EmployeeSearchPO(WebDriver driver)
	{	 
        this.driver = driver;
	 ...
	 */ 
		...
		//Details section
			...
			{
				String cssSelector = "#employee_name ul li:nth-of-type(" + row + ")";
			...
			{
				String cssSelector = "#employee_contact ul li:nth-of-type(" + row + ")";
				return selenium.waitTillElementIsVisible(By.cssSelector(cssSelector)).getText().trim();
			}
			...
			{
				String cssSelector = "#employee_address";
				return selenium.waitTillElementIsVisible(By.cssSelector(cssSelector)).getText().trim();
			}
			...
			{
				String cssSelector = "#employee_appointment_interval ul li:nth-of-type(" + row + ")";
				return selenium.waitTillElementIsVisible(By.cssSelector(cssSelector)).getText().trim();
			}
