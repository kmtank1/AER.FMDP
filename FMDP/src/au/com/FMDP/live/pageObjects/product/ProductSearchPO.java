...
public class ProductSearchPO 
{
	 ...
	 */ 
		...
		//Sale price section	
			...
			{
				String cssSelector = "#price-section ul li:nth-of-type(" + row + ")";
				return selenium.waitTillElementIsVisible(By.cssSelector(cssSelector)).getText().trim();
			}
		...
		//Hierarchy section	
			...
			{
				String cssSelector = "fieldset[data-link='#product-groups-section'] ul li:nth-of-type(" + row + ")";
				return selenium.waitTillElementIsVisible(By.cssSelector(cssSelector)).getText().trim();
			}
		...
		//Supplier section	
			...
			{
				String cssSelector = "#productSuppliers table tbody tr:nth-of-type(" + row + ") td:nth-of-type(" + column + ")";;
